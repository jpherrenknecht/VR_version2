...
def calcul_points(D, tp, d_t, angle_vent, vit_vent, range, polaires):
    ...
    # print('angles',-range+90)
    # print('vit_noeuds', vit_noeuds)
    # print ('vitesse sur axe',d_t / 3600 / 60 * vit_noeuds)
    # print ('coeff sur axe latitudes',np.sin(range_radian))
    #print('variations sur  latitudes',d_t / 3600 / 60 * vit_noeuds *  np.sin(range_radian))
    #print ('cos latitude',math.cos(D.imag * math.pi / 180))
    # print('variations sur  longitudes', d_t / 3600 / 60 * vit_noeuds * np.cos(range_radian)/ math.cos(D.imag * math.pi / 180))
    ...
    points_arrivee = D + (d_t / 3600 / 60 * vit_noeuds *  (np.cos(range_radian) / math.cos(D.imag * math.pi / 180)  +   np.sin(range_radian) * 1j))
...
def f_isochrone(pt_init_cplx, temps_initial_iso):
    ...
    t_v_ar_h=min(tab_t)
    print (' minimum du temps ',min(tab_t))
...
# Depart
latitude_d = '37-04-00-N'
longitude_d = '11-46-00-W'
...
#todo provisoire
# plt.xlim(-70 ,-68)  # Définit les limites du graphique en x
# plt.ylim(12.5 ,17.5)  # Définit les limites du graphique en x

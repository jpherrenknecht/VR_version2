...
# pourcentage=.1
#
# resultat2=(start+(((((end - start) % 360) + 540) % 360) - 180)*pourcentage)%360
#
#
#
# resint=(end - start) % 360
#
#
#
# print('resultat-inter',resint)
#
# print('resultat2',resultat2)
#
# twa = 180 - abs(((360 - end + start) % 360) - 180)
# print('twa',twa)
# resultat3=start+twa

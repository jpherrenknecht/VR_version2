...
# latitude_d = '043-13-17-N'
# longitude_d = '035-27-30-W'
#
...
# todo on peut modifier suivant la course
dt1 = np.ones(48) * 600  # intervalles de temps 30 fois toutes les 10mn ( 600 s)
